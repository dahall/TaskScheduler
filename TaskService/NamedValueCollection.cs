...
{
	/// <summary>Contains a collection of name-value pairs.</summary>
	[PublicAPI]
	public sealed class NamedValueCollection : IDisposable, ICollection<NameValuePair>, IDictionary<string, string>, INotifyCollectionChanged, INotifyPropertyChanged
	{
		...
		internal NamedValueCollection() => unboundDict = new List<NameValuePair>(5);
		...
		/// <summary>Gets a collection of the names.</summary>
		...
		/// <summary>Gets a collection of the values.</summary>
		...
		/// <summary>Gets the value of the item at the specified index.</summary>
		...
		/// <summary>Gets the value of the item with the specified name.</summary>
		...
		public void Add([NotNull] string name, [NotNull] string value) => Add(new NameValuePair(name, value));

		/// <summary>Adds the elements of the specified collection to the end of <see cref="NamedValueCollection"/>.</summary>
		...
		/// <summary>Copies current <see cref="NamedValueCollection"/> to another.</summary>
		...
		/// <summary>Removes the name-value pair with the specified key from the collection.</summary>
		/// <param name="name">The name associated with a value in a name-value pair.</param>
		...
		/// <param name="value">
		/// When this method returns, the value associated with the specified name, if the name is found; otherwise, <c>null</c>. This
		...
		/// <summary>Gets the collection enumerator for the name-value collection.</summary>
	...
	/// <summary>Pair of name and value.</summary>
	[PublicAPI]
	public class NameValuePair : IXmlSerializable, INotifyPropertyChanged, ICloneable, IEquatable<NameValuePair>, IEquatable<ITaskNamedValuePair>
	{
		...
		/// <summary>Initializes a new instance of the <see cref="NameValuePair"/> class.</summary>
		public NameValuePair() { }

		internal NameValuePair([NotNull] ITaskNamedValuePair iPair) => v2Pair = iPair;
		...
		public string Name
		{
			get => v2Pair == null ? name : v2Pair.Name;
		...
		public string Value
		{
			get => v2Pair == null ? value : v2Pair.Value;
		...
		/// <summary>Implements the operator implicit NameValuePair.</summary>
		...
		{
			if (obj is ITaskNamedValuePair valuePair)
				return (this as IEquatable<ITaskNamedValuePair>).Equals(valuePair);
			if (obj is NameValuePair pair)
				return Equals(pair);
